...
{
    class Lab_2_4_Nia_Imani_Thomas
    {
...
/*3. Use Console.WriteLine to print the results of multiplying myFirstNumber and
            mySecondNumber.*/
            ...
            /*8. Create two strings with the name color1 and color2. Assign color1 the value
            “Yellow”. Assign color2 the value “Red”*/
            String color1 = "Yellow";
            String color2 = "Red";
            //Or String color1 = "Yellow", color2 = "Red" {'Both Work'}
            ...
            /*12. On a new line, assign numbers the value of mySecondNumber divided by
            myFirstNumber.*/
            ...
            /*14. On a new line, assign numbers the value of
             * mySecondNumber divided by myFirstNumber, but this time, cast 
             * myFirstNumber as a double.*/
            ...
            /*16.Use Console.WriteLine to print the text “Breakpoint Here”. Insert a
             * breakpoint to pause execution at this line. Run the program, and
             * inspect the values of all of your variables. Hover your mouse over 
             * the variable to see it’s value appear.*/
            Console.WriteLine("Breakpoint Here");


            /*17. Create a variable called textToNumber as a string with the 
             * value “80473”*/
            String textToNumber = "80473";


            /*18. Create a variable call results as an integer and assign it the 
             * value of 99 * textToNumber. Use int.Parse() to complete the 
             * operation. Print the results.*/
            int results = 99 * int.Parse(textToNumber);
            Console.WriteLine(results);

            /*19. Create a DateTime variable called rightNow and set it’s 
             * value to Datetime.Now. Print the results.*/
